    ...
    >
      ...
      <div className="mt-12 text-center">
        <button
          ...
          className="bg-purple-600 hover:bg-purple-800 text-white text-sm font-semibold px-6 py-2 rounded-lg transition"
        >
                ...
                <div className="flex gap-4 flex-wrap">
                  {selectedProject.colab && (
                    <a
                      ...
                      className="bg-green-600 hover:bg-green-700 text-white lg:px-6 lg:py-2 px-2 py-1 rounded-xl lg:text-xl text-sm font-semibold text-center"
                    >
                      View Colab
                    </a>
                  )}
